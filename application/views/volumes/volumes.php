			...
			<ul
				...
				<li class="me-2">
					<a aria-current="page" x-on:click="open = true"
						...
						class="inline-block p-4 text-xl bg-[#77B0AA] rounded-t-lg h-16 w-60">Published Volumes</a>
					...
					<table class="min-w-full divide-y divide-gray-200 ">
						...
						<tbody class="bg-white divide-y divide-gray-200  ">
							...
							foreach ($volumes as $volume):
								if ($volume["published"] == true && $volume["archived"] == false) {
									...
									<tr>
										...
										<td class="px-4 py-4 text-sm whitespace-nowrap flex flex-row gap-1">
											...
											<a href="archiveVolume?id=<?= $volume["volumeid"] ?>"
												...
												<img src="<?= base_url() ?>assets/arrow-square-down.svg" alt=""
													class="h-5 w-5 inline-block ">
											</a>
											
											<a href="deleteVolume?id=<?= $volume["volumeid"] ?>"
												class="px-2 py-2 bg-[#135D66] rounded-md flex justify-center items-center w-fit">
												<img src="<?= base_url() ?>assets/delete.png" alt=""
													class="h-5 w-5 inline-block ">
											</a>
